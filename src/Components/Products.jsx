        ...
        <div className=" flex justify-between gap-3">
          <div className="w-3/12">
            ...
            {show &&
              <div className="py-5">
                <ul>
                  <div onClick={() => seoShow(!on)} className="flex justify-between font-dm text-[#767676] text-[16px] items-center  border-b-[1px] border-[#767676] py-[10px]">
                    <li>Category 1 </li>
                    {on ? <LuMinus /> : <FiPlus />}
                  </div>
                  {on &&
                    <ul>
                      <li className='justify-between font-dm text-[#767676] text-[16px] items-center font-bold text-center border-b-[1px] border-[#767676] py-[10px] hover:bg-black duration-300'>ONE</li>
                      <li className='justify-between font-dm text-[#767676] text-[16px] items-center font-bold text-center border-b-[1px] border-[#767676] py-[10px] hover:bg-black duration-300'>TWO</li>
                      <li className='justify-between font-dm text-[#767676] text-[16px] items-center font-bold text-center border-b-[1px] border-[#767676] py-[10px] hover:bg-black duration-300'>THREE</li>
                    </ul>
                  }


                  <div onClick={() => sewShow(!toww)} className="flex justify-between font-dm text-[#767676] text-[16px] items-center  border-b-[1px] border-[#767676] py-[10px]">
                    <li>Category 2 </li>
                    {toww ? <LuMinus /> : <FiPlus />}
                  </div>
                  {toww &&
                  ...
                  <div onClick={() => seTShow(!three)} className="flex justify-between font-dm text-[#767676] text-[16px] items-center  border-b-[1px] border-[#767676] py-[10px]">
                    <li>Category 3 </li>
                    {three ? <LuMinus /> : <FiPlus />}
                  </div>
                  {three &&
                    <ul>
                      <li className='justify-between font-dm text-[#767676] text-[16px] items-center font-bold text-center border-b-[1px] border-[#767676] py-[10px] hover:bg-black duration-300'>ONE</li>
                  ...
                  <div onClick={() => seFShow(!four)} className="flex justify-between font-dm text-[#767676] text-[16px] items-center  border-b-[1px] border-[#767676] py-[10px]">
                    <li>Category 4 </li>
                    {four ? <LuMinus /> : <FiPlus />}
                  </div>
                  {four &&
                  ...
                  <div onClick={() => seFFShow(!five)} className="flex justify-between font-dm text-[#767676] text-[16px] items-center  border-b-[1px] border-[#767676] py-[10px]">
                    <li>Category 5 </li>
                    {five ? <LuMinus /> : <FiPlus />}
                  </div>
                  {five &&
              ...
              <div className="flex gap-2">
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <div className="  px-[10px] ">
                    <div className="w-24">
                      <select
                        className="block w-full rounded-md border border-gray-300 bg-white hover:bg-black hover:text-[#767676] px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                      >
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
